...
Requires an Apple Silicon Mac, macOS 13+, and a Swift 6 toolchain (Xcode 16+).
...
also validates `Resources/Info.plist`, `Resources/PrivacyInfo.xcprivacy`, and
the sandbox entitlements, then verifies the resulting code signature.
...
For Mac App Store packaging, see [RELEASE.md](RELEASE.md).
